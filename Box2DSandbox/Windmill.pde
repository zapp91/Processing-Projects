...
class Windmill {
  ...
  Windmill(float x, float y, boolean reverseSpin) {
    ...
    box1 = new PhysicsObject(x, y, 200, 10, 0, #FC7DC8, #FC7DC8, false, 0, Box2DBodyType.DYNAMIC, 1, 0.6, 0.5, Shape.RECTANGLE); 
    box2 = new PhysicsObject(x, y, 200, 10, 0, #FC7DC8, #FC7DC8, true, 0, Box2DBodyType.STATIC, 1, 0.6, 0.5, Shape.CIRCLE); 
